...
final class StudentResource extends JsonResource
{
    ...
    {
        return ['id' => $this->id, 'code' => $this->code, 'first_name' => $this->first_name, 'last_name' => $this->last_name, 'full_name' => trim("{$this->first_name} {$this->last_name}"), 'date_of_birth' => $this->dob, 'enrollment_status' => $this->enrollment_status, 'class_section_id' => $this->class_section_id, 'has_login' => $this->user_id !== null, 'relationship' => $this->whenPivotLoaded('parent_student', fn () => $this->pivot->relationship), 'is_primary_contact' => $this->whenPivotLoaded('parent_student', fn () => (bool) $this->pivot->is_primary), 'created_at' => $this->created_at?->toISOString(), 'updated_at' => $this->updated_at?->toISOString(), 'class_section' => $this->whenLoaded('classSection', fn () => ['id' => $this->classSection->id, 'grade' => $this->classSection->grade, 'section' => $this->classSection->section])];
    }
}
